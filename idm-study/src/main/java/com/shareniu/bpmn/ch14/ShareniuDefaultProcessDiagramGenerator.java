...
public class ShareniuDefaultProcessDiagramGenerator extends DefaultProcessDiagramGenerator {
    ...
    protected static DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new ShareniuDefaultProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY,
